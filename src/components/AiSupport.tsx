  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "fixed bottom-6 right-4 md:bottom-8 md:right-6 z-50 w-12 h-12 md:w-14 md:h-14 flex items-center justify-center rounded-full shadow-[0_4px_20px_rgba(0,0,0,0.15)] transition-all duration-300 active:scale-90",
          isOpen
      ...
      <div
        className={cn(
          "fixed bottom-20 right-4 md:bottom-24 md:right-6 z-50 w-[calc(100%-2rem)] max-w-sm transition-all duration-300 origin-bottom-right",
